            ...
            <Container text>
                ...
                {userStore.isLoggedIn ? (
                    ...
                    <>
                        ...
                        <Button style={{marginTop: 25}} onClick={() => modalStore.openModal(<LoginForm />)}  size='huge' inverted>
                            Login
                        </Button>
                        <Button style={{marginTop: 25}} onClick={() => modalStore.openModal(<RegisterForm />)}  size='huge' inverted>
                            Register
                        </Button>
                    </>
